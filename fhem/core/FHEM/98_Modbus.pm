##############################################################################
# $Id: 98_Modbus.pm 23625 2021-01-27 15:18:16Z StefanStrobel $
...
<ul>
    ...
    <ul>
        ...
        <li><b>skipGarbage</b></li> 
            by default when waiting for a response, the module will skip bytes that can not be the start of correct frames.<br>
