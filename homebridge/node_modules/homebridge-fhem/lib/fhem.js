...
//console.log( 'value: ' + value );
                   ...
                   if( connection.fhem.alexa_device ) {
                     ...
                     if( device === connection.fhem.alexa_device.Name ) {
                       if( reading === 'alexaMapping' || reading === 'alexaTypes' || reading === 'fhemIntents'
...
FHEM.prototype.execute = function(cmd, callback) {
  if( this.alexa_device )
    //FHEM_execute(this.log, this.connection, 'setreading '+ this.alexa_device.Name +'  active 1 ' );
    FHEM_execute(this.log, this.connection, '{$defs{'+ this.alexa_device.Name +'}->{"active"} = 1}' );
  FHEM_execute(this.log, this.connection, cmd, callback)
  if( this.alexa_device )
    //FHEM_execute(this.log, this.connection, 'setreading '+ this.alexa_device.Name +'  active 0 ' );
    FHEM_execute( this.log, this.connection,'{$defs{'+ this.alexa_device.Name +'}->{"active"} = 0}' );
};
                ...
                function(result) {
                  try {
                    ...
                    if( d.totalResultsReturned === 1 ) {
                      ...
                      for( var characteristic_type in this.xxx.mappings ) {
